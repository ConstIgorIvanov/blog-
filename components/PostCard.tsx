    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-150 transform hover:-translate-y-1 inline-block bg-pink-400 cursor-pointer px-8 py-3 rounded-full hover:bg-pink-700 text-white">
            More
          </span>
        </Link>
      </div>
